...
import { COOKIE_NAMES } from "@/shared/auth";
...
describe("CookieHelper", () => {
    ...
    it("should return undefined when cookies is null", () => {
        ...
        expect(CookieHelper.get(req, COOKIE_NAMES.ACCESS_TOKEN)).toBeUndefined();
    });
    ...
    it("should return the cookie value when the cookie exists", () => {
        ...
        expect(CookieHelper.get(req, COOKIE_NAMES.ACCESS_TOKEN)).toBe("access-token");
    });

    it("should return undefined when the cookie does not exist", () => {
        const { req } = makeSut();
        req.cookies.accessToken = "access-token";
        expect(CookieHelper.get(req, COOKIE_NAMES.REFRESH_TOKEN)).toBeUndefined();
    });
    ...
    it("should return an empty string when the cookie value is an empty string", () => {
        ...
        expect(CookieHelper.get(req, COOKIE_NAMES.ACCESS_TOKEN)).toBe("");
    });
    ...
    it("should return the requested cookie when multiple cookies exist", () => {
        ...
        expect(CookieHelper.get(req, COOKIE_NAMES.REFRESH_TOKEN)).toBe("refresh-token");
    });
